const API_URL = 'https://fatigue-monitoring-system-api.onrender.com';
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    joinForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            // Fix Timer Offset: Inject the exact local join time
            meetingData.user_joined_at = new Date().toISOString();
